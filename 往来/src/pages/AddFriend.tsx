...
export default function AddFriend() {
  ...
  const handleEventChange = (id: string, field: keyof FriendEvent, value: any) => {
  ...
  const handleSave = async () => {
    ...
    await addFriend({
      ...
      notes,
      events,
      avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCrv9BRiWSjYaEBH9tMa9c86eBwPG7wX1hoKCTh3UETPiZY52l3y9SrNQa77rrQ3rBmcQBbCknFTqQ_-OVb6wzHEX01ULR4V9-X6edSe7aXz8hYtU-oX6R2l2AhsGfeNzO5pmdgqOINxngDlhNMB8_xWu9jac8sZWZnIX9EJxiD36qUqfiWwqo2i12nt47M8c16XGNQKcWbws69_5N6l_Nv1j_cQUgJa8Y8BJ1BqO9UjJLQPjM0Bu65nCDEh5C70lHDI1S1ZoIquO2Y'
    });
    navigate('/friends');
  };
  ...
  return (
    <div className="flex flex-col min-h-full bg-background-light">
      ...
      <div className="sticky top-0 z-10 flex items-center bg-background-light/90 backdrop-blur-md p-4 pb-2 justify-between border-b border-primary/10">
        ...
        <h2 className="text-slate-900 text-lg font-bold leading-tight tracking-tight flex-1 text-center">添加联系人</h2>
          ...
          <div className="flex flex-col gap-4 items-center">
            <div className="relative group cursor-pointer">
              <div 
                ...
                style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCrv9BRiWSjYaEBH9tMa9c86eBwPG7wX1hoKCTh3UETPiZY52l3y9SrNQa77rrQ3rBmcQBbCknFTqQ_-OVb6wzHEX01ULR4V9-X6edSe7aXz8hYtU-oX6R2l2AhsGfeNzO5pmdgqOINxngDlhNMB8_xWu9jac8sZWZnIX9EJxiD36qUqfiWwqo2i12nt47M8c16XGNQKcWbws69_5N6l_Nv1j_cQUgJa8Y8BJ1BqO9UjJLQPjM0Bu65nCDEh5C70lHDI1S1ZoIquO2Y")' }}
              >
